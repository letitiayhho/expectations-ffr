...
#SBATCH --time=02:00:00 # 2 hrs enough for almost all, attempt 1 40 min
#SBATCH --partition=bigmem2 # bigmem2 for midway2, bigmem for midway3
#SBATCH --ntasks=1
#SBATCH --mem-per-cpu=300G # 300G enough for most, attempt 1 128 G
...
def main(sub, run):
    ...
    if raw.info['sfreq'] == 10000.0: # resample from 10k to 5k for subs 1-9
        raw, events = raw.resample(5000.0, events = events)
